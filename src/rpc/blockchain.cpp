...
{ //  category              name                      actor (function)         okSafeMode
  //  --------------------- ------------------------  -----------------------  ----------
	...
	// Themis
    { "blockchain",         "getaccountinfo",         &getaccountinfo,         true  },
    { "blockchain",         "getstorage",             &getstorage,             true  },
    ...
    { "blockchain",         "listcontracts",          &listcontracts,          true  },
    { "blockchain",         "gettransactionreceipt",  &gettransactionreceipt,  true  },
    { "blockchain",         "searchlogs",             &searchlogs,             true  },

    { "blockchain",         "waitforlogs",            &waitforlogs,            true  },
